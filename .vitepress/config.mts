...
export default defineConfig({
  ...
  themeConfig: {
    ...
    footer: {
      message:  `CSDN博主 大宝贱 为<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="red" width="16px" height="16px" style="vertical-align: middle; display: inline-block;">
